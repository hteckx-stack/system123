      ...
      <CardContent className="space-y-4 pt-0">
        ...
        <div className="space-y-2.5">
          <div className="flex items-center text-[13px] text-[#6B7280]">
            ...
            <span className="font-medium">{staff.phone || "No phone listed"}</span>
          </div>
          <div className="flex items-center text-[13px] text-[#6B7280]">
      ...
      <CardFooter className="flex justify-between items-center gap-2 pt-0 border-t border-slate-50 bg-slate-50/30 p-4">
        {staff.status === 'pending' ? (
          <div className="flex w-full gap-2">
            <Button 
              size="sm" 
              className="flex-1 bg-[#22C55E] hover:bg-[#1ea34d] font-bold text-xs rounded-xl h-10 shadow-md shadow-[#22C55E]/10"
            ...
            <Button 
              variant="outline" 
              size="sm" 
              className="flex-1 text-red-600 border-red-100 hover:bg-red-50 font-bold text-xs rounded-xl h-10"
          ...
          <>
            ...
            <Button 
              variant="ghost" 
              size="sm" 
              className="h-10 text-primary hover:text-primary hover:bg-white font-bold gap-2 bg-white/50 rounded-xl"
